"""
This API operates independently of JavaScript runtime but operates at a slightly slower speed compared to utilizing JavaScript runtime.

Main module: Js2Py

Js2Py is capable of translating and executing nearly any JavaScript code.
Developed in pure Python, Js2Py stands as an implementation of JavaScript core within Python, without relying on any external dependencies.
...
class SnaptikDownloader:
    ...
    def _variable_decoder(self, variable_tuple):
        ...
        return context.result(*variable_tuple)
